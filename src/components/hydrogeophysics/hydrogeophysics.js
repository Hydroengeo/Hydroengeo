    ...
    <section className="hydrogeophysics">
      <div className="container">
        ...
        <ul className="hydrogeophysics__list">
          ...
          <li className="">
            <p className="hydrogeophysics__info">сейсмотомографии;</p>
          </li>

          <li className="">
            <p className="hydrogeophysics__info">электроразведки (ВЭЗ, ВЭЗ-ВП);</p>
          </li>

          <li className="">
            <p className="hydrogeophysics__info">электротомографии;</p>
          </li>

          <li className="">
            <p className="hydrogeophysics__info">электропрофилирования;</p>
          </li>

          <li className="">
            <p className="hydrogeophysics__info">радиометрии;</p>
          </li>

          <li className="">
            <p className="hydrogeophysics__info">
              скважинной сейсморазведки (сейсмокаротаж, вертикальное сейсмическое
              профилирование);
            </p>
          </li>

          <li className="">
            <p className="hydrogeophysics__info">георадарными;</p>
          </li>
        ...
        <h2 className="hydrogeophysics__info hydrogeophysics__info--bold">
          Недавно проведенные научно-исследовательские работы;
        </h2>

        <p className="hydrogeophysics__info">
          «Проведение геофизических работ на объекте «Правобережный коллектор» в Бухарской
          области» (ООО «UZGIP»);
        </p>

        <p className="hydrogeophysics__info">
          Проведение инженерно-геофизических работ для разработки РД «Строительство
          хвостохранилища МОФ-3» АО АГМК в рамках реализации инвестиционного проекта
          «Освоение месторождения Ёшлик-1»» (ГУП «O’zGEORANGMETLITI»);
        </p>

        <p className="hydrogeophysics__info">
          «Проведение независимого геотехнического контроля качества ведения строительных
          работ по объекту «Увеличение полезной емкости Дехканабадского селеводохранилища
          до 20.0 млн.м3» («Кашкадарё сув курилиш инвест» ГУП);ф
        </p>
        ...
        <p className="hydrogeophysics__info">
          "Изучение факторов, влияющих на возникновение оползневых явлений на руднике
          "Кальмакир" АО Алмалыкский ГМК"
        </p>
        ...
        <p className="hydrogeophysics__info hydrogeophysics__info--margin">
          Разработка новых методов и рекомендаций использования геофизических методов
          выявления перспективных месторождений пресных, минеральных, термальных подземных
          вод Внедрение современных геофизических методов при изучение загрязнения
          геологической среды, процессов подтопления территорий, динамики оползневых
          смещений, геологического строения, физико-механических свойств, степени
          нарушенности пород, устойчивости . гидротехнических и др. инженерных сооружений,
          моделирование геофизических полей для решения различных задач гидрогеологии и
          инженерной геологии
        </p>
        ...
        <h3 className="hydrogeophysics__info hydrogeophysics__info--bold">
          1. Инженерно-геологические задачи
        </h3>
        ...
        <ul className="hydrogeophysics__list">
          <li className="">
            <p className="hydrogeophysics__info">
              Оценка влажности, трещиноватости, пористости, плотности, прочностных и
              деформационных показателей и закарстованности горных пород
            </p>
          </li>
          ...
          <li className="">
            <p className="hydrogeophysics__info">Изучение оползневых процессов</p>
          </li>
        ...
        <h3 className="hydrogeophysics__info hydrogeophysics__info--bodl">
          2. Гидрогеологические задачи
        </h3>
        ...
        <ul className="hydrogeophysics__list">
          ...
          <li className="">
            <p className="hydrogeophysics__info">Оценка минерализации подземных вод</p>
          </li>
          ...
          <li className="">
            <p className="hydrogeophysics__info">
              Оценка взаимосвязи грунтовых вод с поверхностными водами и водами
          ...
          <li className="">
            <p className="hydrogeophysics__info">Оценка водопроницаемости горных пород</p>
          </li>
        ...
        <h3 className="hydrogeophysics__info hydrogeophysics__info--bold">
          3. Геотехнические задачи
        </h3>

        <ul className="hydrogeophysics__list">
          <li className="">
            <p className="hydrogeophysics__info">Изучение состояния дамб, плотин</p>
          </li>

          <li className="">
            <p className="hydrogeophysics__info">
              Обследование состояний грунтов, слагающих основания зданий, уникальных
              сооружений, исторических памятников и ведение мониторинга
            </p>
          </li>
        ...
        <h3 className="hydrogeophysics__info hydrogeophysics__info--bold">
          4. Геоэкологические задачи
        </h3>

        <ul className="hydrogeophysics__list">
          <li className="">
            <p className="hydrogeophysics__info">Картирование нефтяных загрязнений</p>
          </li>

          <li className="">
            <p className="hydrogeophysics__info">
              Картирование погребенных участков полигонов бытовых и
              промышленно-технических отходов
            </p>
          </li>
        </ul>
        ...
        <h2 className="hydrogeophysics__info hydrogeophysics__info--bold hydrogeophysics__info--text">
          Достижение лаборатории Гидрогеофизики
        </h2>

        <ul className="hydrogeophysics__list">
          <li className="">
            <p className="hydrogeophysics__info">
              различные методические рекомендации по применению геофизических методов и
              способов обработки и интерпретации при поисках и разведки пресных и
              термоминеральных подземных вод в различных геологических условиях на
          ...
          <li className="">
            <p className="hydrogeophysics__info">
              методические рекомендации по изучению опасных инженерно-геологических
              процессов.
            </p>
          </li>
          ...
          <li className="">
            <p className="hydrogeophysics__info">
              методические рекомендации по изучению распространения нефтяного загрязнения
          ...
          <li className="">
            <p className="hydrogeophysics__info">метод данной фильтра метрии.</p>
          </li>
          ...
          <li className="">
            <p className="hydrogeophysics__info">
              ...
              <br />
              - измеритель уровня подземных вод
              <br />
              - донный фильтромер
              <br />
        ...
        <p className="hydrogeophysics__info">
          В результате деятельности лаборатории «Гидрогеофизика» сотрудниками получены 18
          авторских свидетельствий патентов, предложены 20 рационализаторских предложений,
          защищены 12 кандидатских диссертаций и 1 докторская.
        </p>
        ...
        <h2 className="hydrogeophysics__info hydrogeophysics__info--bold hydrogeophysics__info--text">
          Геофизические исследования при оценке состояния грунтов, слагающие основания
        ...
        <h2 className="hydrogeophysics__info hydrogeophysics__info--bold hydrogeophysics__info--text">
          Полученные патенты за период деятельности лаборатории
        </h2>
